...
// AnimatedBackground component temporarily disabled for deployment
// This component will be re-enabled once tsparticles compatibility issues are resolved
...
/* 
 * Original AnimatedBackground implementation with tsparticles - commented out for deployment
 * 
 * The component was causing TypeScript build errors with tsparticles v3.9.1
 * Will be restored once compatibility issues are resolved
 * 
